  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pattern as @pattern" do
        ...
        post :create, {:pattern => { "name_pl" => "invalid value" }}, valid_session
        assigns(:pattern).should be_a_new(Pattern)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pattern" do
        ...
        Pattern.any_instance.should_receive(:update_attributes).with({ "name_pl" => "MyString" })
        put :update, {:id => pattern.to_param, :pattern => { "name_pl" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the pattern as @pattern" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Pattern.any_instance.stub(:save).and_return(false)
        put :update, {:id => pattern.to_param, :pattern => { "name_pl" => "invalid value" }}, valid_session
        assigns(:pattern).should eq(pattern)
      end
